...
catci_y=LIMIT_LOW
catci_shift=10
cactci_center_x=catci_x+img_cati.get_width()
cactci_center_y=catci_y+img_cati.get_height()
cati_detect_r=max(img_cati.get_width(),img_cati.get_height())/2-15
...
while True:
    ...
    if is_hit(ds_center_x, ds_center_y, cactci_center_x, cactci_center_y, cati_detect_r + ds_detect_r ):
        print("hit!!!")
    # 畫出碰撞偵測範圍
    pygame.draw.circle(screen, RED, (int(cactci_center_x), int(cactci_center_y)), cati_detect_r + ds_detect_r, 1)
